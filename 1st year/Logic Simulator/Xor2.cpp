...
Xor2::Xor2(const GraphicsInfo &r_GfxInfo, int r_FanOut):Gate(2, r_FanOut,pair<int,int>(59,15),
...
void Xor2::Draw(ApplicationManager* pManager)
{
	if(!Mark)
	{
...
void Xor2::change_graphic(int x,int y)
{
	m_GfxInfo.x1 =x;
	m_GfxInfo.y1 = y;
...
void Xor2::DrawConnections(ApplicationManager*A)
{
...
void Xor2::SaveComponent(int i,ApplicationManager *pManager)
{
...
CompInfo Xor2::getCompSave()
{
	return COMPS;
}

string Xor2::getComp_Type()
 {
	/* COMPS.compType;*/
	 return "XOR2";
}
