...
Not::Not(const GraphicsInfo &r_GfxInfo, int r_FanOut):Gate(1, r_FanOut,pair<int,int>(59,18),pair<int,int>(0,18))
{
...
void Not::Draw(ApplicationManager* pManager)
{
	if(!Mark)
	{
...
void Not::change_graphic(int x,int y)
{
	m_GfxInfo.x1 =x;
	m_GfxInfo.y1 = y;
...
void Not::DrawConnections(ApplicationManager*A)
{
...
void Not::SaveComponent(int i,ApplicationManager *pManager)
{
...
CompInfo Not::getCompSave()
{
	return COMPS;
}

string Not::getComp_Type()
 {
	/* COMPS.compType;*/
	 return "NOT";
}
